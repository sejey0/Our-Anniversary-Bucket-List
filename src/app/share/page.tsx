...
import { BucketItem, CATEGORY_COLORS, PRIORITY_COLORS, STATUS_COLORS, CATEGORY_EMOJIS } from '@/types/bucket';
    ...
    <div className="min-h-screen py-8 px-4">
      <div className="max-w-3xl mx-auto">
                ...
                <div className="flex-1">
                  <h3
                    className={`font-semibold ${
                      item.status === 'Completed' ? 'line-through text-slate-500' : 'text-slate-800 dark:text-slate-100'
                    }`}
                  >
                  ...
                  <div className="flex flex-wrap gap-1.5 mt-2">
                    <span className={`badge ${CATEGORY_COLORS[item.category] || CATEGORY_COLORS.Other}`}>
                      {item.category}
                    </span>
        ...
        <div className="text-center mt-8 text-sm text-slate-400">
          ...
          <a href="/" className="text-pink-500 hover:text-pink-600 mt-2 inline-block">
            Go to full app →
          </a>
        </div>
      </div>
