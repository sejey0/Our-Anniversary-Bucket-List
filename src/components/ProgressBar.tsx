  ...
  return (
    <div className="card animate-slide-up">
      <div className="flex items-center justify-between mb-3">
        <h3 className="font-semibold text-slate-700 dark:text-slate-200">Overall Progress</h3>
      ...
      <div className="grid grid-cols-3 gap-4 mt-4">
        <div className="text-center">
          ...
          <div className="text-xs text-slate-500 dark:text-slate-400">Total Dreams</div>
        </div>
        <div className="text-center">
